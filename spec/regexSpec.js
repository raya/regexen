describe("your regexes", function(){
  ...
  it("should detect nearby words", function(){
    ...
    var containsNearbyWords = function(haystack, needle){
      var regexPattern = "\\s(\\w|\\')+\\s(\\w|\\')+\\s";
      var regexPatternWithVariables = "(" + needle + ")" + regexPattern + "(" + needle + ")$";
      var regex = new RegExp(regexPatternWithVariables);
      var doesMatch = regex.test(haystack);
      return doesMatch;
    };
